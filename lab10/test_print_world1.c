...
int main(){
   ...
   struct bot bots[] = {
      ...
      {"T-101", 107117, 10, &l[6], NULL, 135, 45, 6, 157370, 1717753},
   };
  ...
  // print_world(&bots[0]);
	//printf("%d",find_distance(&l[0],&l[10],&bots[0]));
	printf("%d",transaction_commodity_distance(&bots[0]));
	//printf("%s",l[2].commodity->name);
   return 0;
}
